...
AWallActor::AWallActor()
{
	...
	//FRotator abc(0,0,0);	
	Up->SetRelativeTransform(FTransform(FRotator(0.0f, 0.0f, 0.0f), FVector(350.0f, 0, 540.0f), FVector(2.0f,4.0f, 20.0f)));
	Down->SetRelativeTransform(FTransform(FRotator(0.0f, 0.0f, 0.0f), FVector(-350.0f, 0, 540.0f), FVector(2.0f, 4.0f, 20.0f)));
	Right->SetRelativeTransform(FTransform(FRotator(0.0f, 90.0f, 0.0f), FVector(0, 350.0f, 540.0f), FVector(2.0f, 4.0f, 20.0f)));
	Left->SetRelativeTransform(FTransform(FRotator(0.0f, 90.0f, 0.0f), FVector(0, -350.0f, 540.0f), FVector(2.0f, 4.0f, 20.0f)));
